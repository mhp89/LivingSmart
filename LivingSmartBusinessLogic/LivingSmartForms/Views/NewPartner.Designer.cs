...
namespace LivingSmartForms.Views
{
    partial class NewPartner
    {
        ...
        private void InitializeComponent()
        {
			...
			this.lblPartnerTimeZone.ForeColor = SmartColor.Dark;
			...
			this.lblPartnerName.ForeColor = SmartColor.Dark;
			...
			this.lblPartnerCity.ForeColor = SmartColor.Dark;
			...
			this.lblPartnerRegionShort.ForeColor = SmartColor.Dark;
			...
			this.lblPartnerCountry.ForeColor = SmartColor.Dark;
			...
			this.lblPartnerPhone.ForeColor = SmartColor.Dark;
			...
			this.lblPartnerEmail.ForeColor = SmartColor.Dark;
			...
			this.stbCity.BackColor = SmartColor.Light;
			...
			this.stbCity.ForeColor = SmartColor.Dark;
			...
			this.stbCountry.BackColor = SmartColor.Light;
			...
			this.stbCountry.ForeColor = SmartColor.Dark;
			...
			this.stbTimeZone.BackColor = SmartColor.Light;
			...
			this.stbTimeZone.ForeColor = SmartColor.Dark;
			...
			this.stbRegionShort.BackColor = SmartColor.Light;
			...
			this.stbRegionShort.ForeColor = SmartColor.Dark;
			...
			this.stbRegion.BackColor = SmartColor.Light;
			...
			this.stbRegion.ForeColor = SmartColor.Dark;
