...
namespace LivingSmartForms.Views
{
    partial class NewAppointment
    {
        ...
        private void InitializeComponent()
        {
			...
			this.stbAppointmentDescription.TabIndex = 6;
			this.stbAppointmentDescription.TabStop = false;
			...
			this.stbAppointmentPlace.TabIndex = 5;
			this.stbAppointmentPlace.TabStop = false;
			...
			this.dafAppointmentEnd.TabIndex = 4;
			// 
			// lblAppointmentEnd
			// 
			...
			this.pnlAppointmentEstateAgent.TabIndex = 0;
			// 
			...
			this.btnAppointmentFindEstateAgent.TabIndex = 0;
			...
			this.pnlAppointmentCustomer.TabIndex = 1;
			// 
			...
			this.btnAppointmentFindCustomer.TabIndex = 0;
			...
			this.pnlAppointmentCase.TabIndex = 2;
			// 
			...
			this.btnAppointmentFindCase.TabIndex = 0;
			...
			this.dafAppointmentStart.TabIndex = 3;
			// 
			// NewAppointment
			// 
